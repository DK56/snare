...
"""
# This script is an easy implementation of a LeNet-300-100 architecture
...
lenet5 = Sequential()
lenet5.add(layers.Dense(300, input_shape=(784,), activation="tanh"))
lenet5.add(layers.Dense(100, activation="tanh"))
